  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (!abort) {
          setError("No se pudieron cargar tus sorteos.");
          setMsg("No se pudieron cargar tus sorteos.");
          setMsgType("error");
        }
      } finally {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-8 bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-white/20">
            ...
            <div className="relative flex items-center justify-between p-6">
              <div>
                ...
                <p className="text-gray-600 mt-1">Administra y comparte tus sorteos</p>
              </div>
              <button
          ...
          {raffles.length === 0 ? (
            <div className="text-center py-12 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
              ...
              <h3 className="text-lg font-medium text-gray-900">No tienes sorteos creados</h3>
              <p className="mt-1 text-gray-500">Empieza creando tu primer sorteo para comenzar</p>
              <div className="mt-6">
                <button
                  onClick={() => router.push("/admin/crear-sorteo")}
